...
function showWelcome() {
  ...
  let dist = getDistance(30.527385,114.355178, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function createtime1() {
  var grt = new Date("11/04/2022 00:00:00"); //此处修改你的建站时间或者网站上线时间
...
function share_() {
  ...
  try {
    ...
    navigator.clipboard.writeText('glen & blog的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("11/04/2022 00:00:00");
...
if (localStorage.getItem("snow") == undefined) {
  localStorage.setItem("snow", "block"); //TODO
}
